...
<body>
  <section class="slide" id="slide-1">
    <div class="header">
      <div>
        <div class="label">Supertools · interner Status · 14.08.2026 · aktualisiert</div>
        <h1>Status quo für die Besprechung</h1>
        <p class="meta">Ziel: gemeinsam prüfen, was bereits steht, wie Website, Datenbasis, Crawler-Prozess und Qualitätslogik zusammenspielen und welche Entscheidungen vor der nächsten produktiven Phase nötig sind.</p>
      </div>
      <div class="right">
    ...
    <div class="status-table">
      ...
      <div class="cell">01 Website</div><div class="cell">Interne Vorschau mit Startseite, Kategorien, Tool-Listen, Basis-Profilen, Cross-Navigation auf Toolseiten, Anbieterstrecke und Social-Feed.</div><div class="cell">Finale Toolliste, echte Vollprofile, CMS, Formulare, Newsletter, Rechtstexte, bessere Logos.</div><div class="cell">Welche Tools gehen in die finale öffentliche Fassung?</div>
  ...
  <section class="slide" id="slide-2">
    <div class="header">
      ...
      <div class="right"><p class="meta">Die Website ist als interne Vorschau bereits nutzbar. Neu sind 72 integrierte Website-Tools, Cross-Navigation auf Toolprofilen und ein Social-Feed mit echten lokalen Instagram-Snapshots.</p></div>
    </div>
    ...
    <div class="journey-grid">
      <figure class="journey-card start">
        ...
        <p class="journey-note">Nutzer:innen kommen über Amtshelden, Newsletter, Social oder Suche auf die Startseite und wählen einen Einstieg.</p>
      </figure>
      ...
      <figure class="journey-card">
        ...
        <p class="journey-note">In der Kategorie werden mehrere passende Produkte vergleichbar: Suche, Filter, Logos und Kurzbeschreibungen.</p>
      </figure>
      ...
      <figure class="journey-card">
        ...
        <p class="journey-note">Auf der Detailseite entstehen Vertrauen und Aktion: Produktblick, Quellen, CTA und weitere Tool-Vorschläge.</p>
      </figure>
    </div>
...
try {
  ...
  for (const shot of shots) {
    ...
    if (shot.prepare === "category-list") {
      await page.evaluate(() => {
        const toolLink = document.querySelector('a[href^="/tools/"]');
        toolLink?.scrollIntoView({ block: "center" });
        window.scrollBy(0, -120);
      });
      await pause(400);
    }
    if (shot.prepare === "tool-detail") {
      await page.evaluate(() => {
  ...
  const htmlPath = path.join(outDir, "supertools-status-quo-klar-2026-08-14.html");
  await fs.writeFile(htmlPath, html, "utf8");

  await page.setViewport({ width: 1600, height: 900, deviceScaleFactor: 1 });
  await page.goto(`file://${htmlPath}`, { waitUntil: "networkidle0" });
  await page.pdf({
    path: path.join(outDir, "supertools-status-quo-klar-2026-08-14.pdf"),
    width: "16in",
    height: "9in",
