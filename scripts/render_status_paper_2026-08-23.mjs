...
<body>
  <section class="slide" id="slide-1">
    ...
    <div class="status-table">
      ...
      <div class="cell">01 Website</div><div class="cell">Als Entscheidungshilfe umgebaut: Kategorie-Seiten führen vom Problem zur Auswahl, Basis-Profile sind Prüfflächen, Startseite mit Anwendungsbeispielen. „Empfehlung“ raus, Profilstufen sichtbar.</div><div class="cell">Echte Praxisfälle, eigene Formate (Glossar, Anbieterfragen), CMS, Formulare, Newsletter, Rechtstexte.</div><div class="cell">Welche Tools gehen in die finale öffentliche Fassung?</div>
